// Generated from C:/Users/mfran/IdeaProjects/Prueba\lexico.g4 by ANTLR 4.10.1
...
public class lexico extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSEIF", "ELSE", "WHILE", "FUNCTION", "RETURN", "LET", "CI", "CD", 
			"PI", "PD", "PUNTOCOMA", "COMA", "AND", "OR", "XOR", "NEG", "SUM", "REST", 
			"MULT", "DIV", "EXP", "MOD", "IGUAL", "MENORQUE", "MENORIGUALQUE", "MAYORQUE", 
			"MAYORIGUALQUE", "IGUALA", "DISTINTO", "LINEA", "BLOQUE", "WS", "DIGITO", 
			"SIGNO", "ENTERO", "REAL", "NUMERICO", "TEXTO", "ESCAPE", "BOOLEANO", 
			"COMILLASIMPLE", "LETRA", "VAR"
		};
	}
